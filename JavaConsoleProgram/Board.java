...
public class Board {
	...
	*/
    ...
    public String paddOutput(Integer number,String filler){
        /*
	...
	*/
	String maxNumber;
	String result = "";
	maxNumber = Integer.toString(this.totalNodes);
	if (number > 0) {
        ...
        */
        ...
        for (int x = 0; x < this.allNodes.size(); ++x) {
            ...
            if (currentNode.getOrderVisited() != 0) {
               Integer order = currentNode.getOrderVisited();
               System.out.println(this.paddOutput(order, "0") + " ");
            } else {
                Integer order = currentNode.getOrderVisited();
                System.out.println(this.paddOutput(order, "XXX") + " ");
            }
            counter++;
        }
    }
